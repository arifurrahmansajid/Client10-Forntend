...
export default function DeleteVideos() {
  ...
  const handleDelete = async () => {
    ...
    if (currentTab === "public") {
      const confirmDelete = confirm("Are you sure you want to delete ALL public videos?");
      ...
      const confirmDelete = confirm("Are you sure you want to delete ALL your private videos?");
      if (!confirmDelete) return;
