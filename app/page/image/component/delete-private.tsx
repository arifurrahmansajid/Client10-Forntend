...
export default function DeletePrivateImages() {
  ...
  const handleDelete = async () => {
    if (currentTab !== "private") {
        toast.error("Please switch to Private tab to delete your private images");
        return;
    }
    
    const confirmDelete = confirm("Are you sure you want to delete ALL your private images? This cannot be undone.");
