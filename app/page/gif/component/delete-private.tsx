...
export default function DeletePrivateGIF() {
  ...
  const handleDelete = async () => {
    if (currentTab !== "private") {
        toast.error("Please switch to Private tab to delete your private gifs");
        return;
    }
    
    const confirmDelete = confirm("Are you sure you want to delete ALL your private gifs? This cannot be undone.");
