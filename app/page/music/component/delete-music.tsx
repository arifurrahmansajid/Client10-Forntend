...
export default function DeleteMusic() {
  ...
  const handleDelete = async () => {
    ...
    if (currentTab === "public") {
      const confirmDelete = confirm("Are you sure you want to delete ALL public music?");
      ...
      const confirmDelete = confirm("Are you sure you want to delete ALL your private music?");
      if (!confirmDelete) return;
