...
export default function DeletePrivateMusic() {
  ...
  const handleDelete = async () => {
    if (currentTab !== "private") {
        toast.error("Please switch to Private tab to delete your private music");
        return;
    }
    
    const confirmDelete = confirm("Are you sure you want to delete ALL your private music? This cannot be undone.");
    if (!confirmDelete) return;

    const res = await mutation<{ message: string }>({
      url: `${process.env.NEXT_PUBLIC_BACKEND_URL}/music/delete-private`,
      method: "DELETE",
      headers: {
